...
function addMarker(place)
{
  ...
  google.maps.event.addListener(marker, "click", function() { articles(marker, place.place_name + "," + place.admin_name1); });
  markers.push(marker); 
}     
...
function initialize() {
  var fenway = new google.maps.LatLng(54.14366, -165.78546);
